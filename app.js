...
PokemonObjectFromId("3")

PokemonObjectFromName("Ivysaur")

PokemonObjectFromNum("025")
...
function PokemonObjectFromId(PokemonId){
  ...
  for( var i=0; i<PokemonObject.length; i++)
  {
...
function PokemonObjectFromName(PokemonName){
  ...
  for( var k=0; k<PokemonObject.length; k++)
  {
      if(PokemonObject[k].name == PokemonName)
      {
 ...
 function PokemonObjectFromNum(PokemonNum){
   ...
   {
     if(PokemonObject[l].num== PokemonNum)
     {
       console.log(PokemonObject[l]);
     }
   }
 }
 ...
 function PokemonObjectFromIdNameNum(PokemonId,PokemonName,PokemonNum){
   for(var j=0; j<PokemonObject.length; j++)
   {
     if(PokemonObject[j].id==PokemonId && PokemonObject[j].name==PokemonName && PokemonObject[j].num==PokemonNum)
     {
